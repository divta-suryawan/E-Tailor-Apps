<x-template>
  ...
  <x-container>
    <div class="text-2xl font-bold mb-4 text-center sm:text-start">Tim kami</div>
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2">
      <x-card-team image="baju-jahit-2.jpeg" name="fandi ahmad" position="frontend developer"/>

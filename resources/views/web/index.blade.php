      ...
      $(document).ready(() => {
        ...
        searchInput.on('input', function() {
          ...
          var filteredData = response.data.filter(function(item) {
            return item.package_name.toLowerCase().includes(searchTerm) || item.tailor.tailor_name.toLowerCase().includes(searchTerm) || item.description.toLowerCase().includes(searchTerm)
          });
